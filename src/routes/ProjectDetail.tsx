...
export default function ProjectDetail() {
  ...
  const techPillStyle = d
    ...
    : undefined;
  const techPillBase = d ? 'rounded-full px-4 py-2 text-sm text-white' : 'rounded-full px-4 py-2 text-sm bg-[#dbeafe] text-[#1e3a5f]';

  if (!project) {
    return (
      <div
        className="mx-auto flex min-h-[70vh] max-w-5xl flex-col items-center justify-center px-6 py-24 text-center sm:px-8"
        style={d ? { color: 'white' } : { color: '#0f172a' }}
      >
    ...
    >
      <div className="mx-auto flex max-w-5xl flex-col gap-10">
        ...
        <div
          ...
          style={d ? glassStrong : { background: '#ffffff', border: '1px solid #e2e8f0' }}
        >
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
            ...
            <div
              ...
              style={d ? glass : { background: '#f0f8ff', border: '1px solid #e2e8f0' }}
            >
              <div>
            ...
            <div
              ...
              style={d ? glass : { background: '#edf4ff', border: '1px solid #e2e8f0' }}
            >
              ...
              <a
                ...
                style={{ background: accent, color: '#000000', boxShadow: d ? `0 0 24px ${accent}44` : 'none' }}
                onMouseEnter={e => (e.currentTarget.style.background = accentHover)}
                onMouseLeave={e => (e.currentTarget.style.background = accent)}
              >
                View on GitHub
